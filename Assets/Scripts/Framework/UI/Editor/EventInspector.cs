...
namespace ScriptableFramework.Variables.UI.Editor
{
    public class EventInspector : EditorWindow
    {
        ...
        Object GetCaller(EventDescription eventDescription)
        {
            ...
            //return string.IsNullOrEmpty(eventDescription.CallerObject) ||
            //       string.IsNullOrEmpty(eventDescription.CallerMethod)
            //    ? ""
            //    : string.Format("{0}->{1}()", eventDescription.CallerObject, eventDescription.CallerMethod);
        }
        ...
        Object GetCallee(EventDescription eventDescription, int index)
        {
            ...
            //    eventDescription.Response.GetPersistentTarget(index),
            //    eventDescription.Response.GetPersistentMethodName(index));
        }
